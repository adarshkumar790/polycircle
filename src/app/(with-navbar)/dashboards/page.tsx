...
const PolycircleDashboard = () => {
  ...
  const dashboardData = [
    ...
    { title: "Upline Reward", icon: <UpplineIncomeIcon />, value: `$${dashboardMainData?.uplineAmount.toFixed(2) || 0}`, link: "/dashboard/upline-income" },
    { title: "Super Upline Reward", icon: <LevelIncomeIcon />, value: `$${dashboardMainData?.superUplineAmount.toFixed(2) || 0}`, link: "/dashboard/super-upline-income" },
