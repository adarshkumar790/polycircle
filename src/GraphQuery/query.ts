...
const GRAPH_API_URL = "https://api.studio.thegraph.com/query/112968/polycircless/version/latest";

const ENDPOINTS = [
  "https://api.studio.thegraph.com/query/112968/polycircless/version/latest",
