...
const GRAPH_API_URL = "https://api.studio.thegraph.com/query/115364/polycircle/version/latest";

const ENDPOINTS = [
  "https://api.studio.thegraph.com/query/115364/polycircle/version/latest",
];
